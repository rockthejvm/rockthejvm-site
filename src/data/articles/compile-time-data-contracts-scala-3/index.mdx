...
> "If it compiles, data-contracts align."
> Let's catch schema mismatches at compile time in Scala 3.
...
All code here runs in a vanilla sbt project. You can grab the working code in [github](https://github.com/vim89/compile-time-data-contracts) and run it yourself.
...
**Examples:**
```scala
Option[String]  // Oui Is subtype of Option[?]
                // appliedArgs returns [String]
                // headOption returns Some(String)

Some[Int]       // Oui Some is subtype of Option
                // Returns Some(Int)

String          // Non Not an Option
                // Returns None
```
...
```scala title="ConformsSpec.scala"
package com.example
...
@main def checkConformance(): Unit =
  summon[Conforms[OutOk,      Contract, Policy.Exact]]   // PERFECT compiles
  // summon[Conforms[OutMissing, Contract, Policy.Exact]] // FAIL - compile‑time error (Missing: email:String)
  summon[Conforms[OutMissing, Contract, Policy.Backward]] // YES compiles (migration mode)
```
