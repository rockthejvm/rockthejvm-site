...
When writing multitasking programs, have you ever wondered how its mechanism may work under the hood? I have a similar question. Here is the journey of exploring an apporach alternative to monadic operations style employeed by libraries such as ZIO Fiber, cats-effect Fiber.
...
The installation of required depdendent jars can be referred to at the Makefile [install-concurrent-libraries](https://codeberg.org/chlin501/concurrent4s/src/branch/main/Makefile#L27) target, and [install-continuations-libraries](https://codeberg.org/chlin501/concurrent4s/src/branch/main/Makefile#L37) target. Otherwise, please use the curl command to install those dependencies manully.
