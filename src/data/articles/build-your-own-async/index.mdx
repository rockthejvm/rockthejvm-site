...
```bash
curl -s -L -O --create-dirs --output-dir ./async/libs "https://{maven repo website}/.../{scala or continuations}.jar"
```
...
* Add the *Coroutine* code to **continuations** folder

* Compile the code either by
