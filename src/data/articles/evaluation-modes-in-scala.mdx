...
There are many more aspects of computation that I did not refer to, e.g. asynchrony, side effects, etc.
...
## Scala Constructs For The 4 Evaluation Modes
...
## Conclusion: The Philosophy Hidden in Plain Sight
