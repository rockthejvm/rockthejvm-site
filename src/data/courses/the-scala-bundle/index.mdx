...
- Navigate any Scala codebase with confidence
- Contribute to Scala projects from small libraries to large apps
- Write your own Scala libraries and tools for other developers
- Master the Scala type system and compiler
- Work with expressions, recursion, and type inference
- Apply OOP: classes, traits, mixins, generics, and error handling
- Use functional programming: lambdas, higher-order functions, collections
- Apply map, flatMap, filter, and for-comprehensions
- Master pattern matching and custom extractors
- Apply partial functions, lazy evaluation, and monads
- Work concurrently with Futures, Promises, and parallel collections
- Apply given values, using clauses, and type classes
- Use higher-kinded types and variance
- Solve functional programming interview problems end-to-end
- Practice on lists, trees, graphs, and special problems
</Fragment>
</CourseLayout>
