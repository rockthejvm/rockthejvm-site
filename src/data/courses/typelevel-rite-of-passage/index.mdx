...
faqs:
  - question: How about the ZIO stack?
    answer: I offer a similarly comprehensive course for the ZIO stack, focusing on a different application and approach.
...
tags: [full-stack, project, typelevel, scala-js, tyrian]
question:
...
thanks: <p><a href="https://github.com/davesmith00000">Dave Smith</a>, the maintainer of Tyrian, for quickly reviewing and merging my PR that injects custom HTML. This allows our app to render Markdown on the frontend (pretty cool!).</p><br/><p><a href="https://twitter.com/fellownoodle">@fellownoodle</a> for the amazing Rite of Passage banner.</p>
---
...
<AutoPlayYouTube videoId="D83MaZYUsik" />
...
You should be comfortable writing any sort of Scala code, as we don't go over the Scala fundamentals. The [beginner](/courses/scala-essentials) and [advanced](/courses/advanced-scala) Scala courses focus on the language.

You should already be familiar with [Cats](/courses/cats) and [Cats Effect](/courses/cats-effect). We'll do a round of recap at the beginning of the course, but we'll focus more on the project.
