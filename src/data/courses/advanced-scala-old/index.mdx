...
- Upgrade to Scala 3 quickly
- Use every syntax sugar in the language
- Create custom pattern matching patterns
- Apply partial functions and partially applied functions
- Work with infinite, property-based collections
- Use lazy evaluation and lazy collections
- Work with Futures and Promises
- Use parallel collections
- Apply implicits: classes, methods, arguments, and conversions
- Design and use type classes
- Master multi-inheritance and trait linearization
- Apply variance and variance positions correctly
- Use self types and the "cake" pattern
- Use higher-kinded types and reflection
