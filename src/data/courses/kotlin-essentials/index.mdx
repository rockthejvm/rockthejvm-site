...
**Software engineers or students with some experience with at least another programming language.** The language is not really important - what matters in this course is the mental model, and I'll draw many similarities and differences with other programming languages, including Java, Scala, the C family, Python, JavaScript, and others.
...
- Understand Kotlin in production environments and real projects
- Start contributing to Kotlin projects immediately
- Write applications for Android, server, web, and multiplatform
- Use the Kotlin type system, type inference, and generics
- Write expression-oriented code and use control structures fluently
- Build classes with constructors, properties, and methods
- Use nullables and null-safe operations
- Write extension functions and operator overloads
- Apply the singleton pattern with Kotlin objects
- Use inheritance, abstract classes, and interfaces
- Handle exceptions with Kotlin idioms
- Apply delegation and delegated properties
- Use collection APIs: map, flatMap, filter, fold and more
