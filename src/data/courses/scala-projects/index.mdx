...
### Project 6: Rock the JVM AI

This is a RAG AI chatbot trained on my own blog on camera. It's able to give you contextualized answers with code examples and references where it found the information.
