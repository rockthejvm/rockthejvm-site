...
- not least, how to build a command line </Fragment>
...
- real-time updates with websockets </Fragment>
...
- communicating remotely across the network </Fragment>
