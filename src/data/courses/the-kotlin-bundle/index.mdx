...
- Develop advanced tools and libraries for other developers
- Lead other developers on Kotlin best practice
- Work on any Kotlin platform: Android, multiplatform, server, web
- Be effective in parallel and concurrent Kotlin applications
- Use Kotlin syntax, types, and expression-oriented control flow
- Build classes with properties, constructors, and modern OOP features
- Use nullables, extension functions, and operator overloads
- Apply delegation and delegated properties
- Use advanced generics with variance and variance positions
- Write inline functions and circumvent JVM type erasure
- Work with reified types and reflection
- Create code generators and symbol processors
- Use suspending functions and coroutine builders
- Apply structured concurrency, cancellation, and error handling
- Work with Flows, Channels, and time manipulation in tests
</Fragment>
</CourseLayout>
