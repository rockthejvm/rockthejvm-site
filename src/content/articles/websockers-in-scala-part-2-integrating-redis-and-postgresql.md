...
In this section, we'll implement the protocols necessary for interacting with Postgres in our application using [Skunk](/articles/mastering-skunk-the-scala-library-for-database-interaction).
