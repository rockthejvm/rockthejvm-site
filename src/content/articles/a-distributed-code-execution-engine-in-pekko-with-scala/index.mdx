...
To make the best of this article, I recommend checking out <a href={
// @ts-ignore
frontmatter.repositoryUrl}>the project on GitHub</a> and following the code while reading this article, as many things will make sense along the way.
...
For the details, please view the <a href={`${
// @ts-ignore
    frontmatter.repositoryUrl}/blob/main/README.md`}>README</a> of the original project.
