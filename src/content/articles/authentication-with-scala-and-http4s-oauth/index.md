...
category: guide
excerpt: Discover how to implement OAuth authentication in Scala with http4s and GitHub as your OAuth provider
...
This is a follow-up to the [Authentication with Scala and http4s: 2FA (Two-Factor Authentication)](/articles/authentication-with-scala-and-http4s-oauth-two-factor-authentication) article that was written earlier, and as such is the third article in the series.
...
Before we dive into Scala code, we need to register our application on [github.com](https://github.com), GitHub will provide us with important credentials relevant for our app to function.
...
1. In the upper right corner of your GitHub account, click your profile photo, then click settings.
   ...
   ![Step one to registering our app with GitHub](images/step1.png)

1. Click developer settings in the left sidebar.

   ![Step two to registering our app with GitHub](images/step2.png)
...
1. In the left sidebar, click OAuth apps. If you've never created an app before this button will say, Register a new application.
   ...
   ![Step three to registering our app with GitHub](images/step3.png)

1. Fill in the necessary fields according to the image below and finally register the application.

   ![Step four to registering our app with GitHub](images/step4.png)

1. Copy the Client ID somewhere safe. Also, generate a new client secret and save it in the same location.

   ![Step five to registering our app with GitHub](images/step5.png)

1. Click the update application button at the bottom of the page.

### Configuring Our Application

In the following sections, we'll build our Scala application using [http4s](http4s-unleashing-the-power-of-http-apis-library) for the routing and serving the application, Circe for JSON parsing, and Ciris for configuration.
...
![Project file structure skeleton](images/project-file-structure-skeleton.png)
...
![Index page of our site showing text with a link](images/index-page.png)

When you click the link, you will be redirected to GitHub and prompted to authorize our OauthHttp4s app.

![OAuth authorization page on GitHub](images/github-oauth-page.png)

Once authorization is provided, you will be redirected to our application with a similar response.

![Response page of our site showing the response](images/response-page.png)
