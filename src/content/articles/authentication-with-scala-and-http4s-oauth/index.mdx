...
This is a follow-up to the [Two-Factor Authentication](/articles/authentication-with-scala-and-http4s-oauth-two-factor-authentication) article that was written earlier, and as such is the third article in the series.
