...
We teach Options in-depth in the [Scala Essentials](https://rockthejvm.com/courses/scala) course, along with examples and exercises, if you want to check it out. In this article, we'll introduce Options, show you how they work, and _why_ they exist.
