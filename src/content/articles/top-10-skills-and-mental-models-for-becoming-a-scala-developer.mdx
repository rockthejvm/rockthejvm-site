...
<TipAdmonition>
  Read this article to understand what you need to work with Scala. If you then
  want to learn these skills hands-on, check out the [Scala
  Essentials](/courses/scala-essentials) and [Advanced](/courses/advanced-scala)
  courses on Rock the JVM.
</TipAdmonition>
