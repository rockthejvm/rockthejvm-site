...
ENDPOINT="http://k8splayworkload.com/createMemoryLoad?d=180&m=512&s=28&l=true"  # Target HTTP endpoint
#ENDPOINT="http://k8splayworkload.com/fibonacci?n=50"  # Target HTTP endpoint
