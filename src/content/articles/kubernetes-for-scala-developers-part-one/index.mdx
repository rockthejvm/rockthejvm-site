...
#m: total memory to hold
#s: memory chunks to allocate progressively
#l: flag to enable logging (default: true)
ENDPOINT="http://k8splayworkload.com/createMemoryLoad?d=180&m=512&s=28&l=true"  # Target MEMOORY WORKLOAD HTTP endpoint
