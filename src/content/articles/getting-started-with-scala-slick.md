...
The method _column[Long]_ defines the column type. It takes the string parameter "movie*id" which is the actual column name in the database table. After that, we can provide multiple properties as vararg field.
\_O.PrimaryKey* informs Slick that this column is the primary key.
