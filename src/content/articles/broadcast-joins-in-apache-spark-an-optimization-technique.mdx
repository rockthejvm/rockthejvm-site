...
In this article, we'll explore the concept of broadcast joins in Apache Spark. We'll see how they can be used to optimize joins between large and small DataFrames, and how they can be configured to work automatically.
...
<TipAdmonition>
  This is also a good tip to use while testing your joins in the absence of this
  automatic optimization. We also use this in our [Spark Optimization
  course](/courses/spark-optimization) when we want to test other optimization
  techniques.
</TipAdmonition>
