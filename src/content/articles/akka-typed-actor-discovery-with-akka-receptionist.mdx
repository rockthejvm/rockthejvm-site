...
We talk about discovery in the [Akka Typed](/courses/akka-pekko-essentials) course, in the context of routers and work distribution. It's a pretty powerful technique.

:::

## Prerequisites

This article assumes some basic familiarity with typed actors.
