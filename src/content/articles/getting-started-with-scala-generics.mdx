...
The concept of Scala generics is explained in-depth and with practice exercises in the [Scala Essentials course](https://rockthejvm.com/courses/scala). The code that we write in this article works on both Scala 2 and Scala 3.
...
If you liked this approach, we explain a lot more such core Scala concepts in the [Scala Essentials course](https://rockthejvm.com/courses/scala), so consider checking it out.
