...
The most important aspect of a constraint satisfaction problem is how to maintain the constraints _as we're building the solution_. We did something similar in the [N-Queens](n-queens-in-scala) problem. The way we're going to build up our solution will be:
