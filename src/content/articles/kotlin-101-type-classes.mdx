...
For those who follow the RockTheJvm blog, it's not a surprise. We already introduced scopes in [Kotlin Context Receivers: A Comprehensive Guide ](/articles/kotlin-101-context-receivers#dispatchers-and-receivers).
...
Feedback is welcome at daniel@rockthejvm.com! If this article was difficult and you need to ramp up on Kotlin as fast as possible, you'll love the [Kotlin Essentials course](/courses/kotlin-essentials).
