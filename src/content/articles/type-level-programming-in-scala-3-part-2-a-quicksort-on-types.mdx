...
tags: [fp, scala, scala3, typeSystem]
...
## Type-Level Quicksort: The Concatenation
...
## Type-Level Quicksort: The Partitioning
...
<TipAdmonition>
There are alternative partitioning schemes which the compiler will not be able to validate. This partitioning does not work, for example, although it's perfectly valid.
...
## Type-Level Quicksort: The Sorting Operation
...
## Type-Level Quicksort: Auto-Inferred
...
We need to save the types to runtime. Rob Norris has this amazing tiny (20-line tiny) [library](https://github.com/tpolecat/typename/tree/main) that can do that, with a bit of metaprogramming. Adding the following to `build.sbt`
