...
<NoteAdmonition>
  ...
  deep into ZIO. In this article he'll explore a newer library in the ZIO
  ecosystem: ZIO Kafka. Enter Riccardo:
</NoteAdmonition>
...
<TipAdmonition>
  It's best to declare the decoder and encoder type classes inside the companion
  object of a type.
</TipAdmonition>
