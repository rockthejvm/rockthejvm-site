...
<TipAdmonition>
  This is one of the (dozens of) problems that we solve in the [Scala & FP
  practice
  course](/courses/scala-and-functional-programming-interview-practice), which
  in rough translation is "Scala for coding interviews".
</TipAdmonition>
