...
tags: [Kubernetes, Scala, zero-downtime, auto-scaling, deployment, container, docker, orchestration]
title: "Kubernetes Unleashed: A Scala Developer's Journey into Container Orchestration (Part 1)"
...
![Pod lifecycle](kubernetes-for-scala-developers-part-one/images/kubernetes-pod-lifecycle-sequential-diagram.png)
...
#### Visualization of the Process
![ReplicaSet lifecycle](kubernetes-for-scala-developers-part-one/images/kubernetes-replicaset-lifecycle-sequence-diagram.png)
...
![Service lifecycle](kubernetes-for-scala-developers-part-one/images/kubernetes-service-lifecycle-sequential-diagram.png)
...
![Deployment lifecycle](kubernetes-for-scala-developers-part-one/images/kubernetes-deployment-sequence-diagram.png)
...
ENDPOINT="http://k8splayworkload.com/listOfCars"  # Target HTTP endpoint
CALLS_PER_MINUTE=12000                # Number of calls per minute
TOTAL_MINUTES=2                    # Total duration in minutes
