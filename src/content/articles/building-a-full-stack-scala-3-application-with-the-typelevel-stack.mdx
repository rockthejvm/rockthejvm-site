...
Note how Resources can be composed very nicely with for-comprehensions &mdash; we talk in depth about Resources in the [Cats Effect course](https://rockthejvm.com/courses/cats-effect).
