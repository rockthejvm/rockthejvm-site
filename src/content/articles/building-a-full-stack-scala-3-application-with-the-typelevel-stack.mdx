...
<TipAdmonition>
  Resources can be composed very nicely with for-comprehensions &mdash; we talk
  in depth about Resources in the [Cats Effect course](/courses/cats-effect).
</TipAdmonition>
...
<TipAdmonition>
  If you like what you've seen in this article, check out the [Typelevel Rite of
  Passage](/courses/typelevel-rite-of-passage), where we take all the ideas here
