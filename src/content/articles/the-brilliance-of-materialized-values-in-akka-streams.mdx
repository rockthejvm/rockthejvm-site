...
This article is about one of the most confusing concepts in Akka Streams: materialized values. I've seen many programmers struggle with them and would like to offer a simple explanation.
