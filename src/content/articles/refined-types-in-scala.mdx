...
If you need some intuition on how Refined works, [check out the type-level programming mini-series](/articles/type-level-programming-in-scala-part-1-numbers-and-comparisons)
