...
category: guide
excerpt: Discover how to implement a two-factor authentication system with one-time passwords (HOTP and TOTP) using Scala and http4s
publishedDate: 2023-07-27
tags: [http4s, scala]
title: "Authentication with Scala and http4s: 2FA (Two-Factor Authentication)"
