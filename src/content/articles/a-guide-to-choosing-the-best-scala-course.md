---
category: guide
excerpt: "Discover the best Scala course for your learning journey: explore recommended courses and libraries such as Cats Effect, ZIO, and Apache Spark"
...
- if you're starting out, take [Scala & FP Essentials](/courses/scala-essentials)
- if you're an intermediate Scala user looking to go advanced, take [Advanced Scala](/courses/advanced-scala)
- after mastering Scala, check out [Cats](/courses/cats), [Cats Effect](/courses/cats-effect) and the [Typelevel](/courses/typelevel-rite-of-passage) ecosystem to get the full Scala developer experience
- alternative to Cats Effect: take [ZIO](/courses/zio)
- alternative 2 to Cats Effect is Akka &mdash; I wouldn't recommend spending much time there unless you absolutely need it, in which case I have [a whole bundle](/courses/the-akka-pekko-bundle)
- for learning Spark, take this [Spark course set](/courses/the-spark-bundle)
...
> - In what order should I take your courses?
> - How should I get started with Scala? Which course should I take?
> - Do you have any tips to learn Scala quickly?
...
1. **Look for a course that focuses on _functional programming_ in Scala.** All mainstream languages are pretty similar when it comes to imperative programming, i.e. variables, loops and the like. If you manage to see a preview of the course, the code inside should look pretty strange to you, and that is good! If the teacher uses variables and loops and it looks like regular Java or Python code but with a different syntax, then that course will miss the essentials of Scala.
1. **Look for a deconstructed, progressive learning approach.** For Scala, you should see the following topics, in roughly this order:
...
### Intermediate Topics to Learn: Concurrency, Contextual Abstractions, Type System
...
### What's the Best Scala Course for Advanced Users?
...
> If you want to master the Typelevel ecosystem in my biggest course to date, check out the [Typelevel Rite of Passage](/courses/typelevel-rite-of-passage). We build a full-stack application that I deploy to production, on camera.

If you want to learn Cats Effect, I have a long-form [Cats Effect course for Scala developers](/courses/cats-effect). I also teach pure functional programming with [Cats](/courses/cats) if you'd like that instead.
...
- [Spark Essentials](/courses/spark-essentials) for the fundamentals
- [Spark Optimization](/courses/spark-optimization) for the rare skills and Spark optimization techniques
- [Spark Performance Tuning](/courses/spark-performance-tuning) for the cluster and infrastructure optimization of Spark
- [Spark Streaming](/courses/spark-streaming) for the same Spark principles applied to continuous data
