...
One of the most important skills you can have as a Spark programmer is the ability to read and interpret query plans. A query plan is a blueprint of how Spark will execute your code. It's a tree of operations that Spark will perform on your data, and it's crucial to understand how to read it.
...
<TipAdmonition>
  Whenever you see Exchange in a query plan, that's a performance bottleneck.
</TipAdmonition>
