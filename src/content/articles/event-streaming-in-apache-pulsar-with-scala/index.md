...
category: guide
excerpt: "Apache Pulsar is a cloud-native, distributed messaging and streaming platform handling hundreds of billions of events daily: discover its strengths and see how to use Scala with the pulsar4s client library to interact with it"
publishedDate: 2021-09-23
tags: [pulsar]
title: Event Streaming in Apache Pulsar with Scala
...
![Pulsar's subscription types diagram](images/pulsar-subscription-types-diagram.png)
