...
If you need to learn the fundamentals of streaming with Flink, check out the long-form [Flink course](/courses/flink) here at Rock the JVM.
...
We will be using the default catalogs as well as the default database.
...
Specifying a Time attributes (here _eventTime_ltz_) and watermarks is what allows us to operate properly on even time and also set constraints on temporal operators, which we will shortly.
...
I skipped added the implementation here since our focus is on Flink SQL.
