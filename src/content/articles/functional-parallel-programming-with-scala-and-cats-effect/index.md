---
author: anzori-nika-ghurtchumelia
category: guide
excerpt: "Unlock the full potential of functional parallel processing: A hands-on guide to accelerating performance with Scala and Cats Effect fibers"
publishedDate: 2024-03-18
tags: [cats, cats-effect, http4s, scala, parallelism]
title: Functional Parallel Programming with Scala and Cats Effect
...
![Output of executing `sbt`, `run`, and `curl`](images/sbt-run-curl-results.png)
...
![Output of curling the Typelevel organization](images/curl-typelevel-organization.png)
...
![Output of executing `curl` on contributors](images/curl-contributors.png)
...
![Output of running `curl` on the new route](images/curl-new-route.png)
...
![Testing how many seconds it takes to do operation](images/typelevel-seconds.png)
