...
excerpt: "Demystify the tagless final pattern in Scala: it's not about type classes"
publishedDate: 2021-12-20
tags: [abstract, scala]
title: Tagless Final in Scala Quickly Explained
