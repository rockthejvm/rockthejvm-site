...
<TipAdmonition>
    To properly follow along with the code example, check out the code on <a href={
    // @ts-ignore
    frontmatter.repositoryUrl}>GitHub</a> since this section may contain large code snippets.
</TipAdmonition>
