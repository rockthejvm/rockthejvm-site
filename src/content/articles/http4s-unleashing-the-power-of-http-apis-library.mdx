...
<NoteAdmonition>
  ...
  a proud student of the [Scala with Cats course](/courses/cats). For the last
  15 years, he's learned as much as possible about OOP, and now he is focused on
  his next challenge: mastering functional programming. Riccardo is a senior
  developer, a teacher and a passionate technical blogger.
</NoteAdmonition>
