...
<NoteAdmonition>
  This post was written for Scala 3, but the concepts work almost identically
  for Scala 2 if you replace [givens with
  implicits](/articles/scala-3-givens-vs-implicits).
</NoteAdmonition>
