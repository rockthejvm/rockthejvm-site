...
## The Expressive Testing, No Constraints: FreeSpecs
...
This definition is valid, as the backticks isolate the name of this identifier. The same goes for class names and for method names.
