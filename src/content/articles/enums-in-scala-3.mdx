...
This article is for Scala programmers of all levels, and particularly for those Scala programmers who have been emulating enums in Scala 2 for the longest time.

## Introduction

Your day has come, because Scala 3 now supports enums out of the box. This will be the focus of this article.
