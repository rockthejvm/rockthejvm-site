...
excerpt: In this article, I'll recap 2020's highlights, share key insights and achievements, and unveil exciting plans for the future of Rock the JVM
...
I remember it took me a few days to get my first Twitter follower. After following @rockthejvm, this person clicked the like button on every single tweet I sent for a few months. If you're reading this, @blaizedsouza, thank you. The trust of a single person was enough to keep me writing, recording and sharing. As of December 2, I'm looking at 581 followers on <a href={site.socials.twitter.url} target="_blank" rel="noreferrer">Twitter</a>. Similar on <a href={site.socials.linkedin.url} target="_blank" rel="noreferrer">LinkedIn</a>. I'm not active on Facebook, although I do have a <a href={site.socials.facebook.url} target="_blank" rel="noreferrer">page</a> and I post every once in a while &mdash; can't find a rational reason why, I'll fix that.

## YouTube

By far the most compelling impact has been on <a href={site.socials.youtube.url} target="_blank" rel="noreferrer">YouTube</a>. 3468 subscribers so far!

Besides turning every single article into a video, I also recorded some specials. The [Scala at Light Speed](https://www.youtube.com/watch?v=-8V6bMjThNo&list=PLmtsMNDRU0BxryRX4wiwrTZ661xcp6VPM&ab_channel=RocktheJVM) mini-course was very well received and was watched around 4000 times fully, with another 1000 enrollments on the [main site](https://rockthejvm.com/courses/scala-at-light-speed) (tip: you can download it there!). For a starting channel, I'm pretty happy.
...
- [Spark Streaming](/courses/spark-streaming)
- [Spark Optimization](/courses/spark-optimization)
- [Spark Performance Tuning](/courses/spark-performance-tuning) aka Spark Optimization 2
- [Cats](/courses/cats)
...
At the same time, I've brought all my Udemy courses to the main website and added [some](/courses/the-scala-bundle) [pretty](/courses/the-akka-pekko-bundle) [unbeatable](/courses/the-spark-bundle) [deals](/memberships).
...
<LinkPreview id="https://www.linkedin.com/embed/feed/update/urn:li:share:6625787434913402881" />

and an advanced Spark optimization training at Apple in Cupertino:

<LinkPreview id="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:6631073474788028416" />
...
**For corporate training**: if you'd like to have me hold a course for your team/your company, let me know at <a href={site.socials.email.url} target="_blank" rel="noreferrer">my email</a> &mdash; I'll be happy to help.
