...
- type classes
- everything about the Scala type system - multi-inheritance and trait linearization - variance and variance positions - self types and the "cake" pattern - higher-linded types - reflection - recursive types and F-bounded polymorphism
