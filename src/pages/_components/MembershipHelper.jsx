          ...
          <div className="mx-auto flex max-w-2xl flex-col gap-16 px-6 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center xl:gap-x-20 xl:px-20">
            ...
            <div className="w-full flex-auto">
              ...
              <div className="mt-10 flex flex-row items-center justify-center gap-5 gap-x-6 lg:justify-start">
                <a
                  href="/memberships"
                  className="rounded-md bg-cta px-3.5 py-2.5 text-sm font-semibold text-ctatext shadow-sm hover:bg-accent-1 hover:text-white hover:no-underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Learn more
                </a>
              </div>
