      ...
      >
        ...
        <div className="mt-10">
          <button
            type="submit"
            disabled={!agreed}
            className={`${agreed ? "bg-primary hover:bg-accent-1 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 text-content" : "bg-content text-bkg"} block w-full rounded-md px-3.5 py-2.5 text-center text-sm font-semibold shadow-sm`}
          >
            Let's talk
          </button>
        </div>
